      ...
      <div className="mx-auto max-w-3xl relative text-center">
        ...
        <ScrollReveal delay={0.3}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            <div
              aria-disabled="true"
              className="relative flex items-center gap-3 bg-bg-card border border-border-card rounded-2xl px-6 py-4 opacity-60 cursor-not-allowed"
            >
              ...
              <span className="absolute -top-2 -right-2 bg-gold text-bg-primary text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full">
                Soon
              </span>
            </div>
            ...
            {/* Google Play */}
            <a
              href="https://play.google.com/store/apps/details?id=com.tadabbur.tadabbur"
              target="_blank"
